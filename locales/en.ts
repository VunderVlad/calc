export default {
  ...
  calc: {
    ...
    allergensSection: "Allergens",
    dislikesSection: "Foods I don't like",
    // NEW lists for checkboxes
    allergensList: {
      gluten: "Gluten",
    ...
    delivery: "Delivery",
    name: "Name",
    emailLanguageLabel: "Language of the email (Language of the email must to be the same as language of the website) ",
    emailLanguageOptions: {
      label: "Email language",
      select: "Choose email language",
      en: "English",
      sk: "Slovak",
      ua: "Ukrainian"
    },
